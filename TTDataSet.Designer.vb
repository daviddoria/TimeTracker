...
Partial Public Class TTDataSet
    ...
    Partial Public Class CompanyTableDataTable
        ...
        Private columnPayrollClientNumber As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public ReadOnly Property PayrollClientNumberColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnPayrollClientNumber
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCompanyTableRow(ByVal CompanyName As String, ByVal PayDay As String, ByVal PayrollFaxNumber As String, ByVal MOTD As String, ByVal PayrollContact As String, ByVal OwnerName As String, ByVal CompanyPhone As String, ByVal PayrollSubmission As Date, ByVal PayrollClientNumber As String) As CompanyTableRow
            Dim rowCompanyTableRow As CompanyTableRow = CType(Me.NewRow,CompanyTableRow)
            Dim columnValuesArray() As Object = New Object() {CompanyName, PayDay, PayrollFaxNumber, MOTD, PayrollContact, OwnerName, CompanyPhone, PayrollSubmission, PayrollClientNumber}
        ...
        Friend Sub InitVars()
            ...
            Me.columnPayrollClientNumber = MyBase.Columns("PayrollClientNumber")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnPayrollClientNumber = New Global.System.Data.DataColumn("PayrollClientNumber", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnPayrollClientNumber)
    ...
    Partial Public Class CompanyTableRow
        ...
        Public Property PayrollClientNumber() As String
            Get
                Try 
                    Return CType(Me(Me.tableCompanyTable.PayrollClientNumberColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'PayrollClientNumber' in table 'CompanyTable' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableCompanyTable.PayrollClientNumberColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function IsPayrollClientNumberNull() As Boolean
            Return Me.IsNull(Me.tableCompanyTable.PayrollClientNumberColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetPayrollClientNumberNull()
            Me(Me.tableCompanyTable.PayrollClientNumberColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace TTDataSetTableAdapters
    ...
    Partial Public Class CompanyTableTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT CompanyName, PayDay, PayrollFaxNumber, MOTD, PayrollContact, OwnerName, Co"& _ 
                "mpanyPhone, PayrollSubmission, PayrollClientNumber FROM CompanyTable WHERE (Comp"& _ 
                "anyName = ?)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
    ...
    Partial Public Class PunchEventTableTableAdapter
        ...
        Public Overloads Overridable Function FillByLast(ByVal dataTable As TTDataSet.PunchEventTableDataTable, ByVal AssociateName As String) As Integer
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(AssociateName, String)
                ' added the following 11/28/2011
