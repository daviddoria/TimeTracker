Public Class CompanyClass
    ...
    Private PayrollClientNumber_ As String
    ...
    'Payroll client number accessor/mutator
    Public Property PayrollClientNumber() As String
        Get
            Return PayrollClientNumber_
        End Get

        Set(ByVal Value As String)
            PayrollClientNumber_ = Value
        End Set
    End Property
